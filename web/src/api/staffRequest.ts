...
export function getStaffRequests(params?: { staff_id?: number; week_start?: string; status?: string }) {
...
export function updateStaffRequest(id: number, data: { request_type?: string; reason?: string; status?: string; end_date?: string }) {
  return request.put(`/staff-request/${id}`, data)
}

export function approveStaffRequest(id: number, data: { status?: string; approved_by?: string }) {
...
export function updateFixedShift(id: number, data: { shift_type?: string; note?: string }) {
  return request.put(`/fixed-shift/${id}`, data)
}
